...
public class Ejercicio05 {
    ...
    public static void main(String[] args) {
        ...
        String texto = "El código\n"
                ...
                + "\n"
                + "Enviar.";
        String palabraBuscada ="$Hyperboss";
        String red = "\33[31m"; //Para poner texto en rojo se utiliza este código: "\033[31m"
        //si lasignamos el código a una variable (red) y la concatemanos con un texto: red+"untexto"
        //el texto saldrá en rojo
        String reset = "\u001B[0m"; //Una vez que se aplica el códifo de un color, el texto se seguirá
        //escribiendo en ese color. Para que se vuelva a mostrar en el color por defecto, hay que 
        //indicarlo, y eso se hace añadiedo el código del color por defecto, a partir del lugar en el que
        //deseas que no siga coloreándose el texto
        
        System.out.println("Seleccione opcion");        
        System.out.println("1. Buscar cuantas veces aparece $Hyperboss en el texto");
        System.out.println("2. Sustituir $Hyperboss por JEFAZO en el texto");
        opcion = ArchivoDeClases.leerEntero();
        ...
        switch(opcion){
            case 1: 
                ...
                while(posicion <= texto.length()){
                    posicion = texto.indexOf("$Hyperboss",posicion)+posicion;                                       
                    cont++;
                    }
                */
                //Este bucle busca la posición del texto donde se encuentra la cadena
                //$Hyperboss
                while(texto.indexOf(palabraBuscada) > -1){
                    texto = texto.substring(texto.indexOf(palabraBuscada)+palabraBuscada.length(),texto.length());                              
                    cont++;
                }
                System.out.println("El número de veces que aparece la cadena en el texto es: " +cont);
                break;
            case 2:                
                texto = texto.replace("$Hyperboss",red+"JEFAZO"+reset);                
